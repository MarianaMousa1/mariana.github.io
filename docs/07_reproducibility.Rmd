...
```{r, echo=FALSE}
knitr::include_graphics("artikel_resultaten.png")
```
Figuur1: Bone marrow and colon folic acid (FA)-induced lacZ MF


### Een project kiezen waarvan een gegevensset en R-code worden gedeeld in de projectomgeving. (R code paper)
Onderzoek: "Protective behavior in course of the COVID-19 outbreak – survey results from Germany"
